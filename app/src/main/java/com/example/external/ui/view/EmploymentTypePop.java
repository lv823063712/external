...
/**
 * @ClassName: EmploymentTypePop
 * @Description:
 * @CreateDate: 2020/11/16 10:55
 * @Creator: lf
 */
public class EmploymentTypePop extends BasePopupWindow implements View.OnClickListener {
    private Activity mContext;
    private TextView accomplish, cancle_pop;
    private FrameLayout wheelview_single;
    private SexPicker.selectAll selectAll;
    private String e1ducation = "Full-time";

    public EmploymentTypePop(Activity context) {
        super(context);
...
//        String[] ss = (String[]) list.toArray();
        SinglePicker<String> picker = new SinglePicker<>(mContext, new String[]{"Full-time", "Part-time job"});
