...
/**
 * @ClassName: MonthlyFamilyIncomePop
 * @Description:
 * @CreateDate: 2020/11/16 11:04
 * @Creator: lf
 */
public class MonthlyFamilyIncomePop extends BasePopupWindow implements View.OnClickListener {
    private Activity mContext;
    private TextView accomplish, cancle_pop;
    private FrameLayout wheelview_single;
    private SexPicker.selectAll selectAll;
    private String e1ducation = "<20000";

    public MonthlyFamilyIncomePop(Activity context) {
        super(context);
