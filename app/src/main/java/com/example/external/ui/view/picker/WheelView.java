...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.mWheelview, 0, 0);
            mGravity = a.getInt(R.styleable.mWheelview_mWheelview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.mWheelview_mWheelview_textColorOut, 0xFFa8a8a8);
            textColorCenter = a.getColor(R.styleable.mWheelview_mWheelview_textColorCenter, 0xFF2a2a2a);
            dividerColor = a.getColor(R.styleable.mWheelview_mWheelview_dividerColor, 0xFFd5d5d5);
            dividerWidth = a.getDimensionPixelSize(R.styleable.mWheelview_mWheelview_dividerWidth, 2);
            textSize = a.getDimensionPixelOffset(R.styleable.mWheelview_mWheelview_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.mWheelview_mWheelview_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
        judgeLineSpace();
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (mGravity) {
            case Gravity.CENTER://显示内容居中
                if (isOptions || label == null || "".equals(label) || !onlyShowCenterLabel) {
