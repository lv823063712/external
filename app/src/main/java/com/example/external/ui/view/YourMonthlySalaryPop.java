...
/**
 * @ClassName: YourMonthlySalaryPop
 * @Description:
 * @CreateDate: 2020/11/16 10:59
 * @Creator: lf
 */
public class YourMonthlySalaryPop extends BasePopupWindow implements View.OnClickListener {
    private Activity mContext;
    private TextView accomplish, cancle_pop;
    private FrameLayout wheelview_single;
    private SexPicker.selectAll selectAll;
    private String e1ducation = "0～8000";

    public YourMonthlySalaryPop(Activity context) {
        super(context);
...
//        String[] ss = (String[]) list.toArray();
        SinglePicker<String> picker = new SinglePicker<>(mContext, new String[]{"0～8000", "8000～20000", "20000～30000",
                "30000～50000", ">50000"});
